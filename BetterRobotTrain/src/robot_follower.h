...
/*MyRobotFollower 
* Creates agent that will be chasing Leader based on position instructions
*/
class MyRobotFollower : public Process, public AgentInterface {
    ...
    private:
        double x_pos = 0, y_pos = 0, theta = 0; //robot x y position
        string train_coordinator_ch; //unique agent channel for communicating with leader
